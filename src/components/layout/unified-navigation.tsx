            ...
            <Link href={item.href}>
              <Button
                ...
                className={cn(
                  ...
                  isCollapsed && "px-2",
                  item.category === 'action' && "bg-orange-50 border border-orange-200 hover:bg-orange-100 text-orange-800",
                  item.category === 'special' && "bg-primary/10 border-2 border-primary/30 hover:bg-primary/20 text-primary",
                  item.category === 'admin' && "bg-red-50 border border-red-200 hover:bg-red-100 text-red-800"
                )}
              >
...
export function UnifiedNavigation({ className }: UnifiedNavigationProps) {
  ...
  return (
    <div className={cn("flex-shrink-0 transition-all duration-300", sidebarCollapsed ? "w-16" : "w-64", className)}>
